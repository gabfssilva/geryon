...
public class SimpleServer {
    public static void main(String[] args) {
        ...
        get("/hello/matrix", r -> {
            ...
            //we are extracting over here name and age parameters from "hello" path.
            final String name = r.matrixParameters().get("hello").get("name");
            final String age = r.matrixParameters().get("hello").get("age");

            return supply(() -> ok("{\"name\": \"" + name + "\", \"age\":" + age + "}"));
        });
